...
_G.ZapSettings = {
	...
	["PetSimulator99 - AutoBuyNextEventAreaToggle"] = true, 
	["PetSimulator99 - AutoBuyNearestEventEggToggle"] = true, 
	["PetSimulator99 - AutoCompleteEventGateQuestToggle"] = false, 
	["PetSimulator99 - AutoClaimEasterEggHuntToggle"] = false, 
	["PetSimulator99 - AutoEasterEggRouletteToggle"] = false, 
	["PetSimulator99 - AutoBuyToEasterDiamondEggTableMultiDropdown"] = {}, -- Options = {"Easter Diamond Egg 1x", "Easter Diamond Egg 10x", "Easter Diamond Egg 100x"}
	["PetSimulator99 - AutoBuyToEasterDiamondEggToggle"] = false, 
	["PetSimulator99 - AutoBuyLuckyEasterEggBoostMaximumTimeSlider"] = 12, -- Range = {0, 12}
	["PetSimulator99 - AutoBuyLuckyEasterEggBoostMinimumTimeSlider"] = 11, -- Range = {0, 12}
	["PetSimulator99 - AutoBuyLuckyEasterEggBoostToggle"] = false, 
	["PetSimulator99 - AutoBuyHuntEasterEggBoostMaximumTimeSlider"] = 12, -- Range = {0, 12}
	["PetSimulator99 - AutoBuyHuntEasterEggBoostMinimumTimeSlider"] = 11, -- Range = {0, 12}
	["PetSimulator99 - AutoBuyHuntEasterEggBoostToggle"] = false, 
	["PetSimulator99 - AutoBuySecretEasterEggBoostMaximumTimeSlider"] = 12, -- Range = {0, 12}
	["PetSimulator99 - AutoBuySecretEasterEggBoostMinimumTimeSlider"] = 11, -- Range = {0, 12}
	["PetSimulator99 - AutoBuySecretEasterEggBoostToggle"] = true, 
	["PetSimulator99 - NewGargantuanPetsWebhookInput"] = {"https://discord.com/api/webhooks/1365527586360262676/F6jUz2m6xIO2JBMkjeFuzMxb8Vl6SN3sfrZJpwYXjGGvq3-gS2uEbc50cGc73CWTXEr8"},  
	["PetSimulator99 - NewGargantuanPetsToggle"] = true,  
	["PetSimulator99 - NewTitanicPetsWebhookInput"] = {"https://discord.com/api/webhooks/1365527586360262676/F6jUz2m6xIO2JBMkjeFuzMxb8Vl6SN3sfrZJpwYXjGGvq3-gS2uEbc50cGc73CWTXEr8"},  
	["PetSimulator99 - NewTitanicPetsToggle"] = true,  
	["PetSimulator99 - NewHugePetsWebhookInput"] = {"https://discord.com/api/webhooks/1365527586360262676/F6jUz2m6xIO2JBMkjeFuzMxb8Vl6SN3sfrZJpwYXjGGvq3-gS2uEbc50cGc73CWTXEr8"},   
	["PetSimulator99 - NewHugePetsToggle"] = true,  
	["PetSimulator99 - NewExclusivePetsWebhookInput"] = {"https://discord.com/api/webhooks/1365527586360262676/F6jUz2m6xIO2JBMkjeFuzMxb8Vl6SN3sfrZJpwYXjGGvq3-gS2uEbc50cGc73CWTXEr8"},   
	["PetSimulator99 - NewExclusivePetsToggle"] = true,  
	...
	["PetSimulator99 - AutoBuyEggNameDropdown"] = "EggsTable1", -- Options not properly defined
	...
	["PetSimulator99 - AutoCompleteRankQuestMaxRankValueSlider"] = 33, -- Range = {1, 33}
	...
	["PetSimulator99 - AutoCalimHiddenPresentsToggle"] = true,  
	...
	["PetSimulator99 - AutoEatFruitAmountSlider"] = 40, -- Range = {1, 100}
	["PetSimulator99 - AutoEatFruitTypeDropdown"] = "Shiny", -- Options = {"Normal", "Shiny"}
	...
	["PetSimulator99 - PotionTableMultiDropdown"] = {"Coins", "Damage", "Diamonds", "Treasure Hunter", "Walkspeed", "Lucky", "Huge"}, -- Options = {"Coins", "Damage", "Diamonds", "Treasure Hunter", "Walkspeed", "Lucky", "Huge"}
	...
	["PetSimulator99 - KeysTableMultiDropdown"] = {}, -- Options = {"Crystal Key", "Secret Key", "Tech Key", "Void Key", "Hacker Key"}
	...
	["PetSimulator99 - ObbyDropdown"] = "ObbyList1", -- Options not properly defined
	...
	["PetSimulator99 - AutoBuyPoliceStationEggToggle"] = false, 
	["PetSimulator99 - AutoTeleportToBestSummerEggToggle"] = false, 
	["PetSimulator99 - AutoBuyNearestSummerEggToggle"] = false, 
	["PetSimulator99 - AutoTeleportToVirusBossChestToggle"] = false, 
	["PetSimulator99 - ServerHopWhenNoVirusBossChestModeDropdown"] = "Mode 1", -- Options = {"Mode 1", "Mode 2"}
	["PetSimulator99 - AutoServerHopWhenNoVirusBossChestToggle"] = false, 
	["PetSimulator99 - AutoBreakVirusBossChestToggle"] = false, 
	["PetSimulator99 - AutoBreakVirusGuardsBossChestToggle"] = false, 
	["PetSimulator99 - AutoTeleportToBestVirusEggToggle"] = false, 
	["PetSimulator99 - AutoBuyNearestVirusEggToggle"] = false, 
	["PetSimulator99 - AutoFindTokyoAlleyEggToggle"] = false, 
	["PetSimulator99 - AutoBuyNearestTokioAlleyEggToggle"] = false, 
	["PetSimulator99 - AutoCatchPetsModeDropdown"] = "Bigger Chance First", -- Options = {"Bigger Chance First", "Lower Chance First"}
	["PetSimulator99 - AutoCatchPetsChanceForUltraCubeSlider"] = 10, -- Range = {0, 100}
	["PetSimulator99 - AutoCatchPetsToggle"] = false, 
	["PetSimulator99 - AutoClaimTrainerQuestsRewardToggle"] = false, 
	["PetSimulator99 - AutoBuyPetCubeMerchantToggle"] = false, 
	["PetSimulator99 - AutoServerHopIfNotWoodcuttingTreeModeDropdown"] = "Mode 1", -- Options = {"Mode 1", "Mode 2"}
	["PetSimulator99 - AutoServerHopIfNotWoodcuttingTreeTypeDropdown"] = "Elm", -- Options = {"Golden Willow", "Fantasy", "Elm", "Evergreen", "Birch", "Oak"}
	["PetSimulator99 - AutoServerHopIfNotWoodcuttingTreeToggle"] = false, 
	["PetSimulator99 - AutoWoodcuttingToggle"] = false, 
	["PetSimulator99 - AutoBuyNextAxeMerchantToggle"] = false, 
	["PetSimulator99 - AutoClaimWoodcuttingQuestGiftToggle"] = false, 
	["PetSimulator99 - AutoDoodleBattleTableMultiDropdown"] = {"Cat", "Ducky", "Monkey", "Tiger", "Dragon"}, -- Options = {"Cat", "Ducky", "Monkey", "Tiger", "Dragon"}
	["PetSimulator99 - AutoDoodleBattleModeDropdown"] = "Recommended Skill", -- Options = {"Recommended Skill", "Minimum Skill"}
	["PetSimulator99 - AutoDoodleBattleDragonSkillSlider"] = 25000, -- Range = {17500, 30000}
	["PetSimulator99 - AutoDoodleBattleToggle"] = false, 
	["PetSimulator99 - AutoUsePencilsTableMultiDropdown"] = {}, -- Options = {"Golden Pencil", "Diamond Pencil", "Rainbow Pencil"}
	["PetSimulator99 - AutoUsePencilsToggle"] = false, 
	["PetSimulator99 - AutoClaimPaintSplotchesTableMultiDropdown"] = {}, -- Options = {"Red Paint Splotche", "Green Paint Splotche", "Blue Paint Splotche"}
	["PetSimulator99 - AutoClaimPaintSplotchesToggle"] = false, 
	["PetSimulator99 - AutoMailPencilsAccountUsernameInput"] = false, 
	["PetSimulator99 - AutoMailPencilsTableMultiDropdown"] = {}, -- Options = {"Golden Pencil", "Diamond Pencil", "Rainbow Pencil"}
	["PetSimulator99 - AutoMailGoldenPencilsAmountSlider"] = 25, -- Range = {1, 100}
	["PetSimulator99 - AutoMailDiamondPencilsAmountSlider"] = 10, -- Range = {1, 50}
	["PetSimulator99 - AutoMailRainbowPencilsAmountSlider"] = 5, -- Range = {1, 25}
	["PetSimulator99 - AutoMailPencilsToggle"] = false, 
	["PetSimulator99 - AutoMailDoodleGiftsAccountUsernameInput"] = false, 
	["PetSimulator99 - AutoMailDoodleGiftsAmountSlider"] = 5, -- Range = {1, 25}
	["PetSimulator99 - AutoMailDoodleGiftsToggle"] = false, 
	["PetSimulator99 - AreaDropdown"] = "AreaList1", -- Options not properly defined
	["PetSimulator99 - MachineDropdown"] = "FakeMachineList1", -- Options not properly defined
	["PetSimulator99 - MerchantsDropdown"] = "FakeMerchantList1", -- Options not properly defined
	["PetSimulator99 - VendingMachineDropdown"] = "FakeVendingMachineList1", -- Options not properly defined
	["PetSimulator99 - WalkSpeedEnablerToggle"] = false, 
	["PetSimulator99 - WalkSpeedSlider"] = 16, -- Range = {0, 500}
	["PetSimulator99 - NoClipToggle"] = false, 
	["PetSimulator99 - WhiteScreenToggle"] = false, 
	["PetSimulator99 - ServerHopTypeDropdown"] = "Random", -- Options = {"Random", "Best Ping", "Most Players", "Least Players"}
}
